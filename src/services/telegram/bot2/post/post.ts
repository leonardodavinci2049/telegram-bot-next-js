...
const botoes = {
  inline_keyboard: [
    [
      { text: "🔥 Apollyon", url: "https://t.me/seu_link_apollyon", style: "danger" },
      { text: "💎 Sathariel", url: "https://t.me/seu_link_sathariel", style: "primary" }
    ],
    [
      { text: "®️ Delfos", url: "https://t.me/seu_link_delfos", style: "danger" },
      { text: "©️ The Olympus", url: "https://t.me/seu_link_olympus", style: "primary" }
    ],
    [
      { text: "🗂 Pasta Completa", url: "https://t.me/seu_link_pasta", style: "success" }
    ]
  ]
} as any;
...
©️ <b>Olympus</b> - Fórum de Negócios`;
    ...
    const imageUrl = "https://images.unsplash.com/photo-1618331835717-801e976710b2?q=80&w=800&auto=format&fit=crop";
